...
from domains.gridworld import sample_trajectory
from generators.obstacle_gen import obstacles
sys.path.append('.')
sys.path.remove('.')
...
if __name__ == '__main__':
    ...
    save_path = "dataset/gridworld_{0}x{1}".format(args.dom_size, args.dom_size)
